...
//const authorizationMiddleware = require("./services2/middlewares/authorizationMiddleware");
...
module.exports = {
	...
	nodeID: process.env.NODEID || "stash",
	...
	hotReload: process.env.HOTRELOAD || false,
